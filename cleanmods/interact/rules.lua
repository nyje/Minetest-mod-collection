...
7. Players not carrying a Skeleton Key will have their builds removed.
]]

--The questions on the rules, if the quiz is used.
--The checkboxes for the first 4 questions are in config.lua
interact.s4_question1 = "Is dating allowed?"
...
interact.s4_multi1 = "Griefing is allowed."
interact.s4_multi2 = "I must carry a Skeleton Key."
