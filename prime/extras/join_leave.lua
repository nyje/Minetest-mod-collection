...
if extras.empty~=0 then
    print("[MOD] extras Join/Leave - Restart empty server")
end
if extras.playerhotbar~=0 then
    print("[MOD] extras Join/Leave - Hotbar size "..extras.playerhotbar)
end
if extras.autorollback~=0 then
    print("[MOD] extras Join/Leave - Auto Rollback non players")
end
