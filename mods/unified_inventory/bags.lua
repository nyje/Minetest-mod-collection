...
unified_inventory.register_page("bags", {
    get_formspec = function(player)
    	...
    	if lite then
            local formspec = "background[0.06,0.49;7.92,7.52;ui_bags_main_form.png]"
            formspec = formspec.."label[0,0;"..F("Bags").."]"
            formspec = formspec.."button[0,1.5;2,0.5;bag1;"..F("Bag 1").."]"
            formspec = formspec.."button[2,1.5;2,0.5;bag2;"..F("Bag 2").."]"
            formspec = formspec.."button[4,1.5;2,0.5;bag3;"..F("Bag 3").."]"
            formspec = formspec.."button[6,1.5;2,0.5;bag4;"..F("Bag 4").."]"
            formspec = formspec.."listcolors[#00000000;#00000000]"
            formspec = formspec.."list[detached:"..minetest.formspec_escape(player_name).."_bags;bag1;0.5,0.5;1,1;]"
            formspec = formspec.."list[detached:"..minetest.formspec_escape(player_name).."_bags;bag2;2.5,0.5;1,1;]"
            formspec = formspec.."list[detached:"..minetest.formspec_escape(player_name).."_bags;bag3;4.5,0.5;1,1;]"
            formspec = formspec.."list[detached:"..minetest.formspec_escape(player_name).."_bags;bag4;6.5,0.5;1,1;]"
		...
		get_formspec = function(player)
            ...
            if lite then
                local formspec = (--"image[7,0;1,1;"..image.."]"
                        ...
                        .."list[current_player;bag"..bi.."contents;0,0.5;8,3;]"
                        .."listring[current_name;bag"..bi.."contents]"
                        .."listring[current_player;main]")
                local slots = stack:get_definition().groups.bagslots
                if slots == 8 then
                    formspec = formspec.."background[0.06,0.49;7.92,7.52;ui_bags_sm_form.png]"
                elseif slots == 16 then
                    formspec = formspec.."background[0.06,0.49;7.92,7.52;ui_bags_med_form.png]"
                elseif slots == 24 then
                    formspec = formspec.."background[0.06,0.49;7.92,7.52;ui_bags_lg_form.png]"
                end
