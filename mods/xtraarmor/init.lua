...
local colorlist = {"green","blue","red","yellow","white","black","grey","orange","dark_grey","dark_green","cyan","pink","magenta","violet","brown"}

for _,col in ipairs(colorlist) do
    minetest.register_tool("xtraarmor:helmet_leather_"..col, {
        description = col.." leather cap",
        inventory_image = "xtraarmor_inv_helmet_leather_"..col..".png",
        groups = {leather_helmet=1, armor_head=7, armor_heal=2, armor_use=1000},
        wear = 0,
    })
    minetest.register_tool("xtraarmor:chestplate_leather_"..col, {
        description = col.." leather tunic",
        inventory_image = "xtraarmor_inv_chestplate_leather_"..col..".png",
        groups = {leather_chestplate=1, armor_torso=12, armor_heal=2, armor_use=1000},
        wear = 0,
    })
    minetest.register_tool("xtraarmor:leggings_leather_"..col, {
        description = col.." leather trousers",
        inventory_image = "xtraarmor_inv_leggings_leather_"..col..".png",
        groups = {leather_leggings=1, armor_legs=7, armor_heal=2, armor_use=150},
        wear = 0,
    })
    minetest.register_tool("xtraarmor:boots_leather_"..col, {
        description = col.." leather boots",
        inventory_image = "xtraarmor_inv_boots_leather_"..col..".png",
        groups = {leather_boots=1, armor_feet=7, armor_heal=2,physics_speed=0.15, armor_use=1000},
        wear = 0,
    })
    minetest.register_tool("xtraarmor:shield_leather_"..col, {
        description = col.." leather shield",
        inventory_image = "xtraarmor_inv_shield_leather_"..col..".png",
        groups = {leather_shield=1, armor_shield=7, armor_heal=2, armor_use=1000},
        wear = 0,
    })
    minetest.register_craft({
        type = "shapeless",
        output = "xtraarmor:shield_leather_"..col,
        recipe = {"xtraarmor:shield_leather", "dye:"..col},
    })
    minetest.register_craft({
        type = "shapeless",
        output = "xtraarmor:helmet_leather_"..col,
        recipe = {"xtraarmor:helmet_leather", "dye:"..col},
    })
    minetest.register_craft({
        type = "shapeless",
        output = "xtraarmor:chestplate_leather_"..col,
        recipe = {"xtraarmor:chestplate_leather", "dye:"..col},
    })
    minetest.register_craft({
        type = "shapeless",
        output = "xtraarmor:leggings_leather_"..col,
        recipe = {"xtraarmor:leggings_leather", "dye:"..col},
    })
    minetest.register_craft({
        type = "shapeless",
        output = "xtraarmor:boots_leather_"..col,
        recipe = {"xtraarmor:boots_leather", "dye:"..col},
    })
end
